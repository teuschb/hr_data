...
ggplot(mydata, aes(JobRole)) +
  ...
  labs(list(y = paste("Attrition in ",month,sep = ""), x = "Job Role", title = paste("Attrition by Job Role, ", date, sep = ""))) +
  coord_flip()
