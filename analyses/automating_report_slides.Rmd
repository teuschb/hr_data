...
Another thing I report is the impact of reducing attrition for the job role with the highest attrition.  

```{r}
# Impact of reducing attrition (this needs to be moved to a separate block)
reduction = .02
replacement_cost = 1
