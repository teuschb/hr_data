****  SAS Program to Read in Accessions
...
****    - Change FILENAME Statements for ACCDATA
****       to correct ACCDATA year (e.g. ACCDATA_FY2015.txt);
...
FILENAME ACCDATA "&PATH1.ACCDATA_FY2015.txt";
...
*** Read In Accession Dimension Translation Table;
* define the DYNAMICS text file extract via FILENAME statement;
FILENAME DTacc "&PATH1.DTacc.txt";
DATA DTacc;
INFILE DTacc firstobs=2 dlm=',' dsd missover;
INPUT
ACC	  : $2.
ACCT  : $48.;
RUN;
** End Accession Dimension Translation Table processing;
...
**** END OF PROGRAM TO READ IN Accessions DATA.gov RAW DATA SETS, ****;
